        ...
        <div class="wrapper">
                    ...
                    <div class="details-container">
                                ...
                                <div class="slider-main">
                                    <div class="item">
                                        <a href="#img_popup1"> <img
                                                src="{{ config('global_variables.asset_url') }}/img/front-left-side-47.webp"
                                                alt=""></a>
                                    </div>
                                    <div class="item">
                                        <a href="#img_popup1"> <img
                        ...
                        <div class="interested-product">
                            ...
                            <div class="link-container">
                                <a href="#">
                                    <h3>4 Bed Property close to Luton Town Center By Best Services nad</h3>
                                    <div class="luton-town">
                                        <div class="product-img">
                                            <img src="{{ config('global_variables.asset_url') }}/img/property-1.jpg"
                                                alt="" />
                                        ...
                                        <div class="product-text">
                                            ...
                                            <div class="location-gurgaon"><i class="fa-solid fa-location-dot"></i>
                                                Gurgaon | 10/08/22</div>
                                            <p>Room come with a Bed, Dresser and Table. Sh common area Kitchen on the
                                                sec common area kitchen on the second floor paid.</p>
                            ...
                            <div class="link-container">
                                <a href="#">
                                    <h3>2006 Sheet Alhambra 1.9 TDI Automatic - New Mot B</h3>
                                    <div class="luton-town">
                                        <div class="product-img">
                                            <img src="{{ config('global_variables.asset_url') }}/img/Maruti.jpg"
                                                alt="" />
                                            <span class="room-pictures">
                                                <i class="fa-solid fa-camera"></i>11
                                            </span>
                    ...
                    <div class="contact-conatiner">
                        ...
                        @if (!empty($post->price))
                            <div class="detail-price-bg-color">
                                <div class="itemp-prices"><i class="fa-solid fa-indian-rupee-sign"></i>
                                    {{ number_format($post->price, 2) }}</div>
                            </div>
                        @endif
                        ...
                        @if (count($staySafes) > 0)
                            ...
                            <div>
                                {{-- <ul class="paginationTable">
                                    <?php $message_total = 0; ?>
                                    @foreach ($staySafes as $item)
                                            <p class="tableItem"> {{ $item->message }} </p>
                                        <?php $message_total++; ?>
                                    @endforeach
                                </ul>
                                
                                <div class="d-flex justify-content-between">
                                    <p class="pt-2">Showing 1 of {{$message_total}}</p>
                                    <div class="d-flex justify-content-end" id="pagination-container">
                                ...
                                <div>
                                    <div class="divs mt-3">
                                        ...
                                        <div class="cls2">Lorem Ipsum is simply dummy text of the printing and
                                            typesetting industry. Lorem Ipsum has been the industry's standard dummy text 2
                                        </div>
                                        <div class="cls3">Lorem Ipsum is simply dummy text of the printing and
                                            typesetting industry. Lorem Ipsum has been the industry's standard dummy text 3
                                        </div>
                                    </div>
                                    <div style="font-size:20px" class="d-flex justify-content-end">
                                        <a class="m_pre" id="prev">
                                            << /a>
                                                <p>1 of 3</p>
                                                <a class="m_next" id="next">></a>
                                    </div>
            ...
            <div id="img_popup1" class="overlay">
                <div class="img_popup">
                    ...
                    <div class="content">
                        ...
                        <img src="{{ config('global_variables.asset_url') }}/img/front-left-side-47.webp" />
                    </div>
                </div>
            </div>
            ...
            <div id="img_popup5" class="overlay">
                <div class="img_popup">
                    ...
                    <a class="left" href="#img_popup4">
                        < </a>
                            <a class="right" href="#img_popup6"> > </a>
                            <div class="content">
                                <a class="cancel" href="#"></a>
                                <img src="{{ config('global_variables.asset_url') }}/img/front-left-side-47.webp" />
                            </div>
            ...
            <div id="img_popup6" class="overlay">
                <div class="img_popup">
                    <span class="img_popup-clos-bt">
                        <a class="close" href="#"><i class="fa fa-times" aria-hidden="true"></i></a>
                    </span>
                    <a class="left" href="#img_popup5">
                        < </a>
                            <a class="right" href="#img_popup7"> > </a>
                            <div class="content">
                                <a class="cancel" href="#"></a>
                                <img src="{{ config('global_variables.asset_url') }}/img/front-left-side-47.webp" />
                            </div>
    ...
    <section class="section-more">
        <div class="wrapper">
            <div class="more-option">
                <h2 class="option-title"><span>Find out</span> More</h2>
