...
class VerifyEmail extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $emailTemplateRow = EmailTemplate::select(['subject', 'description', 'notes'])->where('slug', 'email-verify')->where('status', 'active')->first();
